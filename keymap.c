...
enum preonic_keycodes {
  RAISE = SAFE_RANGE,
  MAC_ON, // enable mac mods
  MAC_OFF, // disable mac mods
  FN,
  DB_TILD,
  DB_CIRC,
  DB_ACUT,
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_MAC_MODS] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, KC_LCTL, KC_LGUI, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_MAC_MODS_RAISED] = LAYOUT_preonic_grid(
  _______, _______, _______, A(S(SE_6)), A(SE_3), S(SE_4), A(SE_Y), _______, _______, _______, SE_CIRC, _______,
  _______, A(SE_7), A(S(SE_7)), _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, SE_TILD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, SE_ACUT, SE_GRV,  A(SE_LPRN), A(SE_RPRN), _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
